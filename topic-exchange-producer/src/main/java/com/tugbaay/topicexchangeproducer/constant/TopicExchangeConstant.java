package com.tugbaay.topicexchangeproducer.constant;

public class TopicExchangeConstant {

    public static final String TOPIC_EXCHANGE_PRODUCER = "topic-exchange-producer";
